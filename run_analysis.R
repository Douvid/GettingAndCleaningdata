run_analysis <- function (FolderPath){
      ...
      names(DataFrame1)[2]<-"Activity" # naming the second column Activity
      ...
      names(DataFrame2)[2]<-"Activity" # naming the second column Activity
      ...
      write.table(dt, "Run_Analysis_SmartPhone.txt", row.names=FALSE) #exporting the results to a new file
}
